...
address_space = {
  virtual_network   = "10.210.0.0/16"
  subnet_main       = "10.210.0.0/21"
  subnet_ingress    = "10.210.16.0/24"
  subnet_db_private = "10.210.20.0/24"
  subnet_db_public  = "10.210.22.0/24"
  subnet_postgres   = "10.210.24.0/24"
  subnet_aks        = "10.210.64.0/20"
}
